  ...
  buildCategory({required String title, required String icon, required int index}) {
    return GestureDetector(
      ...
      child: Container(
        ...
        width: 165,
        decoration: BoxDecoration(
          color: selectedIndex == index ? Colors.purple : Colors.grey.shade100,
          borderRadius: BorderRadius.circular(8),
        ),
        child: Padding(
                          ...
                          ElevatedButton(
                              ...
                              style: ButtonStyle(
                                  ...
                                  shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                                      RoundedRectangleBorder(borderRadius: const BorderRadius.all(Radius.circular(8)), side: BorderSide(color: Colors.purple)))),
                              onPressed: () async {
