              ...
              Visibility(
                ...
                child: Padding(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(fontFamily: "Poppinsm", fontWeight: FontWeight.w600, color: Colors.purple, fontSize: 16),
                  ),
                ),
              ),
              const Divider(
    ...
    return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            actions: <Widget>[
              ElevatedButton(
                style: ElevatedButton.styleFrom(backgroundColor: Colors.purple, textStyle: const TextStyle(fontSize: 15, fontWeight: FontWeight.normal)),
  ...
  Widget paymentListView() {
    return Column(
      children: [
        ...
        //                   ? Container(
        //                       decoration: BoxDecoration(
        //                         border: Border.all(color: codPay ? Colors.purple : Colors.black12),
        ...
        //     child: Container(
        //       decoration: BoxDecoration(
        //         border: Border.all(color: razorPay ? Colors.purple : Colors.black12),
        //         borderRadius: const BorderRadius.all(Radius.circular(5.0) //                 <--- border radius here
        //         ),
        //       ),
        //       padding: const EdgeInsets.symmetric(horizontal: 10),
        ...
        //     child: Container(
        //       decoration: BoxDecoration(
        //         border: Border.all(color: stripe ? Colors.purple : Colors.black12),
        //         borderRadius: const BorderRadius.all(Radius.circular(5.0) //                 <--- border radius here
        //         ),
        //       ),
        //       padding: const EdgeInsets.symmetric(horizontal: 10),
        ...
        //     child: Container(
        //       decoration: BoxDecoration(
        //         border: Border.all(color: payTm ? Colors.purple : Colors.black12),
        //         borderRadius: const BorderRadius.all(Radius.circular(5.0) //                 <--- border radius here
        //         ),
        //       ),
        //       padding: const EdgeInsets.symmetric(horizontal: 10),
        ...
        //     child: Container(
        //       decoration: BoxDecoration(
        //         border: Border.all(color: paypal ? Colors.purple : Colors.black12),
        //         borderRadius: const BorderRadius.all(Radius.circular(5.0) //                 <--- border radius here
        //         ),
        //       ),
        //       padding: const EdgeInsets.symmetric(horizontal: 10),
        ...
        //     child: Container(
        //       decoration: BoxDecoration(
        //         border: Border.all(color: payFast ? Colors.purple : Colors.black12),
        //         borderRadius: const BorderRadius.all(Radius.circular(5.0) //                 <--- border radius here
        //         ),
        //       ),
        //       padding: const EdgeInsets.symmetric(horizontal: 10),
        ...
        //     child: Container(
        //       decoration: BoxDecoration(
        //         border: Border.all(color: payStack ? Colors.purple : Colors.black12),
        //         borderRadius: const BorderRadius.all(Radius.circular(5.0) //                 <--- border radius here
        //         ),
        //       ),
        //       padding: const EdgeInsets.symmetric(horizontal: 10),
