...
//                                 style: TextStyle(fontSize: 18, fontFamily: "Poppinsm", letterSpacing: 0.5, color: Colors.purple),
//                               )
//                             : Column(
//                                 crossAxisAlignment: CrossAxisAlignment.start,
//                                 children: [
...
//                         //                       }
//                         //                     },
//                         //                     icon: Icon(Icons.add, size: 18, color: Colors.purple),
//                         //                     label: Text(
//                         //                       'ADD'.tr(),
//                         //                       style: TextStyle(height: 1.2, fontFamily: "Poppinssb", letterSpacing: 0.5, color: Colors.purple),
//                         //                     ),
//                         //                     style: TextButton.styleFrom(
...
//               child: Text(
//                 "COPY CODE".tr(),
//                 style: TextStyle(color: Colors.purple, fontWeight: FontWeight.w500, letterSpacing: 0.1),
//               ),
//             ),
//           ),
//           Container(
