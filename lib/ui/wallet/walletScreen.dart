    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Text(
            "TOPUP WALLET".tr(),
            style: TextStyle(color: Colors.purple, fontWeight: FontWeight.w700, fontSize: 16),
          ),
        ),
      ),
    );
                ...
                ClipOval(
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Icon(Icons.account_balance_wallet_rounded, size: 28, color: Colors.purple),
                    ),
                  ),
                ),
                SizedBox(
                        ...
                        Visibility(
                          ...
                          child: Padding(
                            ...
                            child: Card(
                              ...
                              child: RadioListTile(
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: BorderSide(color: stripe ? Colors.purple : Colors.transparent)),
                        ...
                        Visibility(
                          ...
                          child: Padding(
                            ...
                            child: Card(
                              ...
                              child: RadioListTile(
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: BorderSide(color: payStack ? Colors.purple : Colors.transparent)),
                                controlAffinity: ListTileControlAffinity.trailing,
                                value: "PayStack",
                                groupValue: selectedRadioTile,
                                onChanged: (String? value) {
                        ...
                        Visibility(
                          ...
                          child: Padding(
                            ...
                            child: Card(
                              ...
                              child: RadioListTile(
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: BorderSide(color: flutterWave ? Colors.purple : Colors.transparent)),
                                controlAffinity: ListTileControlAffinity.trailing,
                                value: "FlutterWave",
                                groupValue: selectedRadioTile,
                                onChanged: (String? value) {
                        ...
                        Visibility(
                          ...
                          child: Padding(
                            ...
                            child: Card(
                              ...
                              child: RadioListTile(
                                //toggleable: true,
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: BorderSide(color: razorPay ? Colors.purple : Colors.transparent)),
                                contentPadding: const EdgeInsets.symmetric(
                                  horizontal: 6,
                                ),
                                controlAffinity: ListTileControlAffinity.trailing,
                        ...
                        Visibility(
                          ...
                          child: Padding(
                            ...
                            child: Card(
                              ...
                              child: RadioListTile(
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: BorderSide(color: payFast ? Colors.purple : Colors.transparent)),
                                controlAffinity: ListTileControlAffinity.trailing,
                                value: "payFast",
                                groupValue: selectedRadioTile,
                                onChanged: (String? value) {
                        ...
                        Visibility(
                          ...
                          child: Padding(
                            ...
                            child: Card(
                              ...
                              elevation: payTm ? 0 : 2,
                              child: RadioListTile(
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: BorderSide(color: payTm ? Colors.purple : Colors.transparent)),
                                contentPadding: const EdgeInsets.symmetric(
                                  horizontal: 6,
                                ),
                                controlAffinity: ListTileControlAffinity.trailing,
                        ...
                        Visibility(
                          ...
                          child: Padding(
                            ...
                            child: Card(
                              ...
                              child: RadioListTile(
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: BorderSide(color: mercadoPago ? Colors.purple : Colors.transparent)),
                                controlAffinity: ListTileControlAffinity.trailing,
                                value: "MercadoPago",
                                groupValue: selectedRadioTile,
                                onChanged: (String? value) {
                        ...
                        Visibility(
                          ...
                          child: Padding(
                            ...
                            child: Card(
                              ...
                              child: RadioListTile(
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: BorderSide(color: paypal ? Colors.purple : Colors.transparent)),
                                contentPadding: const EdgeInsets.symmetric(
                                  horizontal: 6,
                                ),
                                controlAffinity: ListTileControlAffinity.trailing,
