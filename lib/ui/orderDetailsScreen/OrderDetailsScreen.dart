              ...
              widget.orderModel.takeAway == false
                  ? Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Address'.tr(),
                          style: TextStyle(fontSize: 16, letterSpacing: 0.5, color: isDarkMode(context) ? Colors.grey.shade200 : Colors.purple, fontFamily: "Poppinsm"),
                        ),
              ...
              Visibility(
                ...
                child: Padding(
                  ...
                  child: InkWell(
                    child: Container(
                        padding: const EdgeInsets.only(top: 8, bottom: 8),
                        decoration: BoxDecoration(color: Colors.purple, borderRadius: BorderRadius.circular(5), border: Border.all(width: 0.8, color: Colors.purple)),
                        child: Center(
                          child: Text(
...
//   ]);
  ...
  getPriceTotalText(CartProduct s) {
    ...
    return Text(
      ...
      style: TextStyle(fontSize: 20, color: Colors.purple, fontFamily: "Poppinsm"),
    );
  }
