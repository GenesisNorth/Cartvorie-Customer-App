              ...
              child: Positioned(
                  ...
                  child: Container(
                      ...
                      child: ElevatedButton(
                        style: ElevatedButton.styleFrom(shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(6)), backgroundColor: Colors.purple),
                        child: Text(
                          "GET STARTED".tr(),
          ...
          Center(
            ...
            child: Align(
              ...
              child: SmoothPageIndicator(
                ...
                effect: ScrollingDotsEffect(spacing: 20, activeDotColor: Colors.purple, dotColor: const Color(0XFFFBDBD1), dotWidth: 7, dotHeight: 7, fixedCenter: false),
              ),
            ),
          )),
          Visibility(
