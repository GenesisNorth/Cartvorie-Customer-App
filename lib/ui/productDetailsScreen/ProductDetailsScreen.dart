                          ...
                          children: [
                            ...
                            widget.productModel.disPrice == "" || widget.productModel.disPrice == "0"
                                ? Text(
                                    ...
                                    style: TextStyle(fontFamily: "Poppinsm", letterSpacing: 0.5, color: Colors.purple),
                                  )
                                : Row(
                                    children: [
                                      Text(
                            ...
                            serviceTypeFlag == "ecommerce-service"
                                ? productQnt == 0
                                    ? TextButton.icon(
                                        ...
                                        label: Text(
                                          'ADD'.tr(),
                                          style: TextStyle(fontFamily: "Poppinsm", color: Colors.purple),
                                        ),
                                    ...
                                    : Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            productQnt.toString(),
                                            style: TextStyle(fontSize: 16, fontFamily: "Poppinsm", color: Colors.purple),
                                          ),
                                          const SizedBox(
                                            width: 5,
                                          ),
                              ...
                              child: Row(
                                children: [
                                  ...
                                  InkWell(
                                      ...
                                      child: Text(widget.vendorModel.title, style: TextStyle(color: Colors.purple))),
                                ],
                              ),
                            ),
                            brandModel == null
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        InkWell(
                                            ...
                                            child: Text(brandModel != null ? brandModel!.title.toString() : "", style: TextStyle(color: Colors.purple))),
                                      ],
                                    ),
                                  ),
                          ],
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Text(
                                            ...
                                            style: TextStyle(fontWeight: FontWeight.bold, fontFamily: "Poppinsm", color: Colors.purple),
                                          ),
                                          GestureDetector(
                                            onTap: () {
                                              setState(() {
                            ...
                            child: Row(
                              children: [
                                ...
                                InkWell(
                                  ...
                                  child: Text(
                                    "Sell All".tr(),
                                    style: TextStyle(fontFamily: "Poppinsm", fontSize: 16, color: isDarkMode(context) ? const Color(0xffffffff) : Colors.purple),
                                  ),
                                ),
                              ],
                            ),
