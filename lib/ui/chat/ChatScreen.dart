              ...
              Positioned.directional(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        color: homeConversationModel.members.firstWhere((element) => element.userID == messageData.senderID).active ? Colors.purple : Colors.grey,
              ...
              child: Padding(
                ...
                child: Stack(clipBehavior: Clip.hardEdge, alignment: Alignment.center, children: <Widget>[
                  Padding(
                    ...
                    child: PlayerWidget(
                      url: messageData.url.url,
                      color: isDarkMode(context) ? const Color(COLOR_ACCENT) : Colors.purple,
                    ),
                  ),
                ]),
              ),
