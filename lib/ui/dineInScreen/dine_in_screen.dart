                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(currentLocation.toString(), maxLines: 2, overflow: TextOverflow.ellipsis, style: TextStyle(color: Colors.purple, fontFamily: "Poppinsr")).tr(),
                        ),
                        InkWell(
                          onTap: () {
                          ...
                          child: Container(
                            ...
                            child: Text("Change".tr(), style: TextStyle(fontSize: 14, color: Colors.purple, fontFamily: "Poppinsr")).tr(),
                          ),
                        ),
                      ],
                    ),
            ...
            children: [
              CachedNetworkImage(
                ...
                imageBuilder: (context, imageProvider) => Container(
                  ...
                  decoration: BoxDecoration(border: Border.all(width: 4, color: Colors.purple), borderRadius: BorderRadius.circular(25)),
                  child: Container(
            ...
            children: [
              ...
              isViewAll!
                  ...
                  : GestureDetector(
                      ...
                      child: Text('View All'.tr(), style: TextStyle(color: Colors.purple, fontFamily: "Poppinsm")),
                    ),
            ],
          ),
        ),
