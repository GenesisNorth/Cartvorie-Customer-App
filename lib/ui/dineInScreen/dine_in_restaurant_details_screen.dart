                            ...
                            GestureDetector(
                              ...
                              child: Align(
                                  ...
                                  child: Container(
                                    ...
                                    decoration:
                                        BoxDecoration(borderRadius: BorderRadius.circular(100), border: Border.all(width: 1, color: isDarkMode(context) ? Colors.purple : Colors.black54)),
                                    child: Icon(
                                      Icons.keyboard_arrow_right,
                                      color: isDarkMode(context) ? Colors.purple : Colors.black54,
                                    ),
                                  )),
                            ),
                          ],
