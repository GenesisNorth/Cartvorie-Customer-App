                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            SizedBox(height: 22, child: Icon(Icons.check_circle, color: Colors.purple)),
                            SizedBox(
                              height: 36,
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    "|",
                                    style: TextStyle(fontWeight: FontWeight.bold, color: Colors.purple, fontSize: 8),
                                  ),
                                  Text(
                                    "|",
                                    style: TextStyle(fontWeight: FontWeight.bold, color: Colors.purple, fontSize: 8),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  bookStatus,
                                  style: TextStyle(
                                    color: (bookStatus == 'Confirmed'.tr()) ? Colors.green : Colors.purple,
                                    fontWeight: FontWeight.w600,
                                    fontSize: 16,
                                  ),
                                ),
                              ...
                              child: ClipOval(
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Icon(Icons.subdirectory_arrow_left, color: Colors.purple, size: 22),
                                  ),
                                ),
                              ),
                            ),
                            ...
                            child: Padding(
                              ...
                              child: ClipOval(
                                child: Container(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(10.0),
                                    child: Icon(Icons.phone, color: Colors.purple, size: 22),
                                  ),
                                ),
                              ),
                            ),
