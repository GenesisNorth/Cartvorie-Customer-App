                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child:
                                    Text(currentLocation.toString(), maxLines: 2, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 14, color: Colors.purple[600], fontFamily: "Poppinsr"))
                                        .tr(),
                              ),
                              InkWell(
                                onTap: () {
                                ...
                                child: Container(
                                  ...
                                  child: Text("Change".tr(), style: TextStyle(fontSize: 14, color: Colors.purple[600], fontFamily: "Poppinsr")).tr(),
                                ),
                              ),
                            ],
                          )),
                      Container(
                          padding: const EdgeInsets.symmetric(vertical: 5, horizontal: 16),
                          child: Text("Hello".tr() + " " + name! + ",", style: TextStyle(fontSize: 24, color: Colors.purple[600], fontFamily: "Poppinsr")).tr()),
                      Container(
                ...
                children: [
                  ...
                  product.disPrice == "" || product.disPrice == "0"
                      ? Text(
                          ...
                          style: TextStyle(fontSize: 16, fontFamily: "Poppinsm", letterSpacing: 0.5, color: Colors.purple[600]),
                        )
                      : Row(
                          children: [
                            Text(
          ...
          children: [
            CachedNetworkImage(
              ...
              imageBuilder: (context, imageProvider) => Container(
                ...
                decoration: BoxDecoration(border: Border.all(width: 6, color: Colors.purple), borderRadius: BorderRadius.circular(30)),
                child: Container(
                  // height: 80,width: 80,
                  decoration: BoxDecoration(
                      border: Border.all(
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Text(
                "COPY CODE".tr(),
                style: TextStyle(color: Colors.purple[600], fontWeight: FontWeight.w500, letterSpacing: 0.1),
              ),
            ),
          ),
          Container(
            ...
            children: [
              ...
              isViewAll!
                  ...
                  : GestureDetector(
                      ...
                      child: Text('View All'.tr(), style: TextStyle(color: Colors.purple[600], fontFamily: "Poppinsm")),
                    ),
            ],
          ),
        ),
